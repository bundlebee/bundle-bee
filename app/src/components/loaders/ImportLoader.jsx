...
export default () => {
  return (
    <div id="loading-circle">
      <svg width="150" height="150" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" className="lds-ripple">
        <circle cx="50" cy="50" r="39.3" fill="none" strokeWidth="8" stroke="#93dbe9">
          ...
          <animate attributeName="opacity" calcMode="spline" values="2;0" keyTimes="0;1" dur="1" keySplines="0.2 0 0.8 1" begin="-0.5s" repeatCount="indefinite" />
        </circle>
        <circle cx="50" cy="50" r="23.4" fill="none" strokeWidth="8" stroke="#689cc5">
